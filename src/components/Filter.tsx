    ...
    return (
        <div className="display-flex">
            <div className="dropdown">
                ...
                {action.clearSet()}
                {sets.map((item, index) => {
                    return <a key={index} className={(item === set) ? "selected-option" : ""} onClick={ () => {action.setSet(item)}} href="/#">{item}</a>
                })}
                </div>
            </div>
            <div className="dropdown">
                ...
                {rarities.map((item, index) => {
                    return <a key={index} className={(item === rarity) ? "selected-option" : ""} onClick={ () => {action.setRarity(item)}} href="/#">{item}</a>
                })}
                </div>
            </div>
            <div className="dropdown">
                ...
                {types.map((item, index) => {
                    return <a key={index} className={(item === type) ? "selected-option" : ""} onClick={ () => {action.setType(item)}} href="/#">{item}</a>
                })}
                </div>
            </div>
        </div>
