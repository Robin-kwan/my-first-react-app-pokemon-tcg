        ...
        PaperProps={{
            ...
            <div className="display-flex space-between">
                <div>
                    ...
                    <br />
                    <span className="clear-all unselectable" onClick={() => action.setCart([])}> Clear all </span>
                </div>
            ...
            <div className="cart-item-div">
                ...
                return <div key={index} className="item-card-cart">
                    ...
                    <div className="display-flex margin-top-10">
                        <div className="item-column">
                            <button className="square-btn" onClick={() => action.removeItem(index)}>
                        ...
                        <div className="price-column">
                            <button className={`square-btn ${(item.set.total === item.amount) ? "disabled-btn" : ""}`} onClick={() => action.addMore(index)}>
                            <span className="font-btn unselectable"> + </span>
                            </button>
                        </div>
                    </div>
